...
const Map<String, String> kDfCabinetErrors = {
  ...
  'CaptchaError': 'Проверка безопасности не пройдена. Нажмите «Обновить проверку» и повторите.',
  'DeviceLimitReached': 'Достигнут лимит устройств по тарифу.',
  'DeviceOwnedByOther': 'Устройство уже привязано к другому аккаунту.',
  'DeviceOnline': 'Устройство сейчас онлайн — отключите клиент, затем удалите.',
  'ConcurrentLimit': 'Лимит одновременных сессий исчерпан. Закройте лишние подключения.',
  'concurrent limit reached': 'Лимит одновременных сессий исчерпан. Закройте лишние подключения.',
  'BotGuardError': 'Автопроверка безопасности не пройдена. Обновите проверку и повторите через пару секунд.',

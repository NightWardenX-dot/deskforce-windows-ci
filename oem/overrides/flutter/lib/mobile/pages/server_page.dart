...
// DeskForce mobile server tab — light panels on paper scaffold
const _dfPaper = Color(0xFFF3EFE6);
const _dfCard = Color(0xFFE8E2D4);
const _dfInk = Color(0xFF12161C);
const _dfMuted = Color(0xFF4A5563);
const _dfBrass = Color(0xFFB8892A);
...
class ServerInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const TextStyle textStyleHeading = TextStyle(
        fontSize: 16.0, fontWeight: FontWeight.bold, color: _dfMuted);
    const TextStyle textStyleValue =
        TextStyle(fontSize: 25.0, fontWeight: FontWeight.bold, color: _dfInk);
    ...
    return PaddingCard(
        ...
        child: Column(
          ...
          children: [
            ...
            // Password
            Row(children: [
              const Icon(Icons.lock_outline, color: _dfMuted, size: iconSize)
                  .marginOnly(right: iconMarginRight),
              Text(
...
class PermissionRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SwitchListTile(
        ...
        title: Text(name, style: const TextStyle(color: _dfInk, fontSize: 15)),
        activeColor: _dfBrass,
        activeTrackColor: _dfBrass.withOpacity(0.45),
    ...
    return SizedBox(
        ...
        child: Card(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: const BorderSide(color: Color(0x3812161C)),
          ),

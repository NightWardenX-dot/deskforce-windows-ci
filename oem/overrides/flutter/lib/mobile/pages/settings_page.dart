...
import '../../common/widgets/deskforce_brand_header.dart';
...
const url = 'https://deskforce.dr6ter.ru/';
      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep DeskForce background service')),
          ...
          tiles: [
            SettingsTile(
                ...
                value: Padding(
                  ...
                  child: Text('deskforce.dr6ter.ru',
                      style: TextStyle(
            ...
            SettingsTile(
              ...
              onPressed: (context) =>
                  launchUrlString('https://deskforce.dr6ter.ru/terms'),
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text(translate('About DeskForce')),
